...
//Reward
$rewardAmount=$_POST['reward_Amount'];
$rewardStatus=$_POST['reward'];
...
$reward->setRewardUsage($rewardStatus);
...
if($status=="success")
{
	echo "ÖDEME İŞEMİ BAŞARILI ŞEKİLDE YAPILDI. Çekilen Tutar ; ".$totalprice." TL";}
