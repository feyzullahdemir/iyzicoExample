...
<div class="row">
<b>Checkout Ödeme</b>
<form action="iyzi1.php" method="POST">
            <fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="enabledInstallments">enabledInstallments</label>

                    <div class="col-sm-10">
                        <input type="text" name="enabledInstallments" id="enabledInstallments" data-validate="required" class="form-control" value="2">
                    </div>
                </div>
                <div class="form-group">
