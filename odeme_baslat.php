...
<div class="row">
<b>Doğrudan ödeme</b>
<form action="odemecheck.php" method="POST">
            <fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="request_paymentGroup" id="paymentGroup" data-validate="required" class="form-control" value="PRODUCT">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label" for="price">Reward Amount</label>

                    <div class="col-sm-10">
                        <input type="text" name="reward_Amount" id="price" data-validate="required" class="form-control" value="2" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">Reaward (status)</label>

                    <input type="radio" name="reward" value="1" id="reward1">Evet
                    <input type="radio" name="reward" value="0" id="reward2" checked="checked">Hayır
                </div>
